 ...
 * {@link com.github.oinsio.gnomish.sandbox.ExecHandle#waitForExitOrTimeout}.
 *
 * <p>The pipeline-config loader never coerces this key into a typed {@link
 * Duration} — {@code AgentSettingsValidator} (task 9.1) only checks the raw
 ...
 * what {@code AgentSettingsValidator} already accepted as well-formed: an
