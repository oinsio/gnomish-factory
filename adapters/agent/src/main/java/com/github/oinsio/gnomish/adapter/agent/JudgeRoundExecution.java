 ...
 *
 * <p>Implements FR1, FR2, FR3, FR6, NFR-R1 of fix-round-stdout-drain.
 */
final class JudgeRoundExecution {
    ...
    static Vote run(
        ...
        try (StreamDrain drain = StreamDrain.start(launched.output(), clock, progressListener)) {
            ...
            return cannotVerify("stream-json carried no result event for round", messageOf(e));
            ...
            return cannotVerify("agent stdout drain did not finish after process exit", messageOf(e));
            ...
            return cannotVerify("interrupted while waiting for the agent stdout drain", messageOf(e));
        }
    }
