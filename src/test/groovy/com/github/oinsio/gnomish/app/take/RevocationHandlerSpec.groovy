...
import com.github.oinsio.gnomish.adapter.git.GitSalvageFailedException
 ...
 * tracker's logical state via park/recordAbort/finish. WorktreeSalvage and BranchPush are final
...
class RevocationHandlerSpec extends Specification implements BareGitRepoFixture {
    ...
    def setup() {
        ...
        branchPush = new BranchPush(runner)
