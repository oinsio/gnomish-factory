 ...
 * retries it and, once the budget is exhausted, returns it as a non-2xx the removal throws on
 * here. A network/transport failure is different — it surfaces earlier as an
 * infrastructure {@link com.github.oinsio.gnomish.adapter.github.GithubHttpException}, never
 * this exception. A version
