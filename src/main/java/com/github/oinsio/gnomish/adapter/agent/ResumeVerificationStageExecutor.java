 ...
 * ({@link SnapshotTipCheck.InterruptedVerification}), the factory died between
...
public final class ResumeVerificationStageExecutor implements StageExecutor {
    ...
    private SnapshotTipCheck.@Nullable InterruptedVerification pending;
    ...
    public ExecutionResult execute(Request request) {
        SnapshotTipCheck.InterruptedVerification p = pending;
