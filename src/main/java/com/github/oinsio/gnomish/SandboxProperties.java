 ...
 * {@link FactoryProperties} (design D2, D7). Kept as an independent top-level
 * {@code @ConfigurationProperties} record rather than nested inside {@link
 * FactoryProperties} so neither file grows past the {@code process-invariants.md}
 * file-size target; {@code @ConfigurationPropertiesScan} on {@link
 * FactoryApplication} picks it up automatically.
 *
