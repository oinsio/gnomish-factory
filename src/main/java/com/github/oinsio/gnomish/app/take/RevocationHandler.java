...
public record RevocationHandler(Tracker tracker, WorktreeSalvage worktreeSalvage, BranchPush branchPush) {
     ...
     *     com.github.oinsio.gnomish.adapter.git.TaskIdSanitizer#branchName}; never blank
     ...
     * @throws com.github.oinsio.gnomish.adapter.git.GitSalvageFailedException if the salvage
