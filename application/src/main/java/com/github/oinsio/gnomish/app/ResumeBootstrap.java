 ...
 *
 * <p>{@code outcome} is kept at the DTO level ({@link RecordedOutcome}, not the domain {@code
 * TaskOutcome}) for the same reason {@code TaskRecord} does — {@code task.json} alone lacks
