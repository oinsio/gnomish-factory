...
final class TakePauseExit {
     ...
     * add-claim-heartbeat): when the claim was reaped or taken over mid-run, the checkpoint park is
     * skipped with a WARN rather than overwriting the new holder's tracker state — the run still
     * returns the mapped {@link TakeResult.AwaitingHuman}.
     *
     ...
     * to the recorded checkpoint (FR5, UX2 of fix-lifecycle-push): the park still lands, and the
