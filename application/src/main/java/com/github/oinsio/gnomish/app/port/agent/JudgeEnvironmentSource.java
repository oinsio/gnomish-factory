 ...
 * {@code DirectoryWorkspace} root, {@code adapter.agent.HostJudgeEnvironmentSource}); in sandboxed
 * mode a fresh environment materialized from the attempt commit ({@code
 * adapter.agent.FreshJudgeEnvironments}) — never the gnome-touched round environment, whose
 * out-of-branch residue (PATH shims, planted binaries) could fake a verdict.
 *
