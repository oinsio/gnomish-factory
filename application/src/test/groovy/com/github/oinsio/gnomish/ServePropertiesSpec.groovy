...
class ServePropertiesSpec extends Specification {
    ...
    def "slots defaults to 2 when unset (0)"() {
        ...
        def properties = new ServeProperties(0, null, null, null, null, null, null)
    ...
    def "slots of an explicit value is exposed unchanged"() {
        ...
        def properties = new ServeProperties(5, null, null, null, null, null, null)
    ...
    def "slots of #value is rejected with the property name in the message"() {
        ...
        new ServeProperties(value, null, null, null, null, null, null)
    ...
    def "slots of 1, the smallest positive value immediately above the boundary, is accepted unchanged"() {
        ...
        def properties = new ServeProperties(1, null, null, null, null, null, null)
    ...
    def "idle-poll-interval of an explicit value is exposed unchanged"() {
        ...
        def properties = new ServeProperties(0, Duration.ofSeconds(45), null, null, null, null, null)
    ...
    def "idle-poll-interval of #value is rejected with the property name in the message"() {
        ...
        new ServeProperties(0, value, null, null, null, null, null)
    ...
    def "sigterm-grace of an explicit value is exposed unchanged"() {
        ...
        def properties = new ServeProperties(0, null, Duration.ofSeconds(10), null, null, null, null)
    ...
    def "sigterm-grace of #value is rejected with the property name in the message"() {
        ...
        new ServeProperties(0, null, value, null, null, null, null)
    ...
    def "worktree-age-threshold of an explicit value is exposed unchanged"() {
        ...
        def properties = new ServeProperties(0, null, null, Duration.ofDays(7), null, null, null)
    ...
    def "worktree-age-threshold of #value is rejected with the property name in the message"() {
        ...
        new ServeProperties(0, null, null, value, null, null, null)
    ...
    def "snapshot-interval of an explicit value is exposed unchanged"() {
        ...
        def properties = new ServeProperties(0, null, null, null, Duration.ofSeconds(15), null, null)
    ...
    def "snapshot-interval of #value is rejected with the property name in the message"() {
        ...
        new ServeProperties(0, null, null, null, value, null, null)
    ...
    def "ledger-retention-days of an explicit value is exposed unchanged"() {
        ...
        def properties = new ServeProperties(0, null, null, null, null, 7, null)
    ...
    def "ledger-retention-days of 0 is accepted unchanged and means keep forever"() {
        ...
        def properties = new ServeProperties(0, null, null, null, null, 0, null)
    ...
    def "ledger-retention-days of #value is rejected with the property name in the message"() {
        ...
        new ServeProperties(0, null, null, null, null, value, null)
    ...
    def "sandbox-sweep-interval of an explicit value is exposed unchanged"() {
        when:
        def properties = new ServeProperties(0, null, null, null, null, null, Duration.ofMinutes(1))
    ...
    def "sandbox-sweep-interval of #value is rejected with the property name in the message"() {
        when:
        new ServeProperties(0, null, null, null, null, null, value)

        then:
        def failure = thrown(IllegalArgumentException)
        failure.message.contains('factory.serve.sandbox-sweep-interval')
